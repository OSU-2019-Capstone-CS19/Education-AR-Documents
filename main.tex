...
\def \CapstoneTeamName{		ARTT - Augmented Reality Teaching Technologies}
\def \CapstoneTeamNumber{		CS19}
\def \GroupMemberOne{			Andrew Snow}
\def \GroupMemberTwo{			Cody McKenzie}
\def \GroupMemberThree{			Josh Strozzi}
\def \GroupMemberFour{			Martin Nguyen}
\def \CapstoneProjectName{		Educational AR using WebXR}
